...
""" function adding to count each time an odd number is iterated """
...
""" function to check if an iterated number is odd """
...
""" function to remove any odd numbers in a list """

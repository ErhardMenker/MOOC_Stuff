# Loading an image using CodeSkulptor: im = simplegui.load_image(url_name)
# After loading, an image is cached and can be drawn with canvas.draw_image() function

""" Code that imports and draws the Gutenberg map in simplegui """

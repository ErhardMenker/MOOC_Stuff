...
# Grids are two dimensional stackings of cells each in which values could exist.
# Two dimensional search is harder than one dimensional search, because you need to choose an extra dimension in which to navigate.
# Breadth-First Search is a search strategy that searches boundary cells and converts those cells to the spreading cells within the boundary, adding them to the boundary.
...
# A common example of Breadth-First Search is modeling the spreading of a fire.

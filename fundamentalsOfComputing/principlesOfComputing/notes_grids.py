## Grids
# Grids are partitions of two dimensional regions into separate cells.
# A grid has two dimensions: grid_height and grid_width.
# Examples: A 3 by 4 grid is 3 cells high by 4 cells wide.
# Cells are referred to by a two-index reference by indicating rows and then columns (still using zero-based indexing, though).

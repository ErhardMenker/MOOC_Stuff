## Plotting
# Plotting is the process of visualizing data into a graphic.
# Plotting is done via the simpleplot module.
# Codeskulptor plots by taking a list of two-element x and y coordinate tuples.
